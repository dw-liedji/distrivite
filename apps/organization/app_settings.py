...
TABULAR_PERMISSIONS_CONFIG = {
    "template": "organization/settings/permissions.html",
    "exclude": {
        "override": False,
        "apps": [],
        "models": [],
        "function": "apps.organization.helpers.dummy_permissions_exclude",
    },
    "auto_implement": True,
    "use_for_concrete": False,
    "custom_permission_translation": "apps.organization.helpers.custom_permissions_translator",
    "apps_customization_func": "apps.organization.helpers.apps_customization_func",
    "custom_permissions_customization_func": "apps.organization.helpers.custom_permissions_customization_func",
}
